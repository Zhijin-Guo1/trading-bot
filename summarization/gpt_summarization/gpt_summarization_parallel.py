"""
Direct 8-K Filing Summarization using gpt-5-mini with parallel processing
"""
import json
import pandas as pd
import numpy as np
...
class ParallelDirectSummarizer:
    ...
    def load_all_2019_data(self, n_samples: Optional[int] = None) -> List[Dict]:
        ...
        print("\n" + "=" * 60)
        print("LOADING 2019 DATA FOR PARALLEL SUMMARIZATION")
        print("=" * 60)
...
def main():
    ...
    # Process all 2019 data (5463 filings)
