"""
Direct 8-K Filing Summarization using gpt-5-mini with parallel processing - 2017 Data
"""
import json
import pandas as pd
import numpy as np
...
class ParallelDirectSummarizer:
    ...
    def load_all_2017_data(self, n_samples: Optional[int] = None) -> List[Dict]:
        """Load filings and labels"""
        print("\n" + "=" * 60)
        print("LOADING 2017 DATA FOR PARALLEL SUMMARIZATION")
        print("=" * 60)

        texts_file = SOURCE_DATA_DIR / "texts" / "merged_texts_2017.json"
        labels_file = SOURCE_DATA_DIR / "enhanced_dataset_2017_2017.csv"
...
Summary:"""
    ...
    def run_full_pipeline(self, n_samples: Optional[int] = None):
        ...
        # Load data
        filings = self.load_all_2017_data(n_samples)
